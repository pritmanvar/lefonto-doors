...
from product.models import ProductMaterial, Category, Feature

# Create your models here.
class Banner(models.Model):
    description = models.CharField(max_length=255, blank=True)
    image = models.ImageField(upload_to='uploads/banners/', null=True, blank=True)
    product_material = models.ForeignKey(ProductMaterial, on_delete=models.SET_NULL, null=True, blank=True)
